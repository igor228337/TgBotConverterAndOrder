...
class Account(Base, ModelAdmin):
    ...
    def __init__(self, telegram_id: int = None, name: str = None, wallet_number: str = None, language: str = None,telegram_name: str = None, refer_user: str = None, date_born: str = None):
        super().__init__()
